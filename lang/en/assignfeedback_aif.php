...
$string['analysisskippedfiles'] = 'Files that cannot be analysed (will be excluded):';
...
$string['batchdeletefeedbackcomplete'] = 'AI feedback has been deleted for the selected students.';
$string['batchoperationconfirmdeletefeedbackai'] = 'Delete AI feedback for all selected users?';
$string['batchoperationconfirmgeneratefeedbackai'] = 'Generate AI feedback for all selected users?';
$string['batchoperationdeletefeedbackai'] = 'Delete AI feedback';
$string['batchoperationgeneratefeedbackai'] = 'Generate AI feedback';
$string['confirmgeneratefeedback'] = 'This will send the student\'s submission data (text and uploaded files) to an AI system for analysis. Files that cannot be converted will be excluded. Any existing AI feedback will be replaced. Continue?';
...
$string['defaultpracticedisclaimer'] = '(This feedback was generated by an AI system.)';
...
$string['errorwrongactinguser'] = 'The AI request cannot be performed, because the current user is not the user the request should be attributed to.';
$string['expertmodeconfirm'] = 'This will replace the current prompt with the expert mode template.<br><br><strong>What is expert mode?</strong><br>In expert mode, you have full control over the entire AI prompt. The admin template is ignored and your prompt is sent directly to the AI.<br><br><strong>Available placeholders:</strong><ul><li><code>{{submission}}</code> - The student\'s submission text (required to activate expert mode)</li><li><code>{{rubric_section}}</code> - The grading criteria section including heading (only included if rubrics are configured)</li><li><code>{{rubric}}</code> - The raw rubric criteria text (without heading)</li><li><code>{{assignmentname}}</code> - The assignment name</li><li><code>{{description_section}}</code> - The assignment description section with heading (empty if no description)</li><li><code>{{description}}</code> - The raw assignment description text</li><li><code>{{instructions_section}}</code> - The activity instructions section with heading (empty if no instructions)</li><li><code>{{activityinstructions}}</code> - The raw activity instructions text</li><li><code>{{language}}</code> - The user\'s language for the response</li></ul><strong>Note:</strong> The presence of <code>{{submission}}</code> in your prompt activates expert mode. Without it, your prompt is inserted into the admin template at the <code>{{prompt}}</code> placeholder.<br><br><strong>Leaving expert mode:</strong> To return to normal mode, simply remove all placeholders (especially <code>{{submission}}</code>) from the prompt field. Your prompt will then be inserted into the admin template as usual.<br><br>Continue?';
$string['expertmodepromptplaceholder'] = 'Please enter your specific prompt or instructions here';
$string['failedtoextractintroattachmentfiles'] = 'Failed to extract text from the intro attachment files: {$a}';
$string['feedbackgenerating'] = 'AI feedback is being generated in the background. This page will refresh automatically once it is ready.';
$string['feedbackgeneratingprogress'] = 'Generating AI feedback ({$a->current}/{$a->total})...';
$string['feedbackgenerationcomplete'] = 'AI feedback has been generated successfully.';
$string['feedbackgenerationerror'] = 'AI feedback generation failed: {$a}';
$string['feedbackskippedfiles'] = 'Note: The following files could not be analysed by the AI and were not included in the feedback: {$a}';
$string['file'] = 'Prompt file';
$string['file_help'] = 'Upload a text file containing the prompt for AI feedback generation. The file content will be used as the prompt instead of the text field above.';
$string['generatefeedbackai'] = 'Generate AI feedback';
$string['introattachmentsheading'] = '[Additional reference files provided by the teacher]';
$string['localaimanager'] = 'Local AI manager';
$string['pluginname'] = 'AI Assisted Feedback';
$string['pluginname_userfaced'] = 'Feedback type \'AI Assisted Feedback\' in the assignment activity';
...
$string['privacy:metadata:errormessage'] = 'Error message from the AI backend if feedback generation failed.';
$string['privacy:metadata:status'] = 'Processing status of the AI feedback (pending, completed, error).';
...
$string['privacy:metadata:timemodified'] = 'The time the AI feedback record was last modified.';
$string['progressstepextracting'] = 'Extracting submission content...';
$string['progresssteppreparing'] = 'Preparing submission data...';
$string['progresssteprequesting'] = 'Requesting AI feedback...';
$string['progressstepsaving'] = 'Saving feedback...';
...
$string['widgetcompleted'] = 'completed';
$string['widgetcounts'] = '{$a->completed} of {$a->total}';
$string['widgeterrors'] = 'failed';
$string['widgetnotstarted'] = 'not started';
$string['widgetpending'] = 'in progress';
$string['widgetretryall'] = 'Retry all';
$string['widgetsystemicerror'] = 'affects {$a} submissions';
$string['widgettitle'] = 'AI Feedback';
