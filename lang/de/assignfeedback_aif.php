...
$string['enablepromptfile'] = 'Prompt-Datei-Upload aktivieren';
$string['enablepromptfile_text'] = 'Wenn aktiviert, können Lehrkräfte in den Aufgabeneinstellungen eine Textdatei als Prompt hochladen.';
...
$string['errorwrongactinguser'] = 'Die KI-Anfrage kann nicht ausgeführt werden, weil der aktuelle Benutzer nicht der Benutzer ist, dem die Anfrage zugeordnet werden soll.';
...
$string['privacy:metadata:errormessage'] = 'Fehlermeldung des KI-Backends, falls die Feedbackgenerierung fehlgeschlagen ist.';
$string['privacy:metadata:status'] = 'Verarbeitungsstatus des KI-Feedbacks (ausstehend, abgeschlossen, Fehler).';
...
$string['privacy:metadata:timemodified'] = 'Der Zeitpunkt, zu dem der KI-Feedback-Datensatz zuletzt geändert wurde.';
...
$string['widgetcompleted'] = 'abgeschlossen';
$string['widgetcounts'] = '{$a->completed} von {$a->total}';
$string['widgeterrors'] = 'fehlgeschlagen';
$string['widgetnotstarted'] = 'nicht gestartet';
$string['widgetpending'] = 'in Bearbeitung';
$string['widgetretryall'] = 'Alle erneut versuchen';
$string['widgetsystemicerror'] = 'betrifft {$a} Abgaben';
$string['widgettitle'] = 'KI-Feedback';
